...
function pfUI:LoadConfig()
  ...
  --
  pfUI:UpdateConfig("buffbar", "tbuff", "enable", "1")
  pfUI:UpdateConfig("buffbar", "tbuff", "use_unitfonts", "0")
  pfUI:UpdateConfig("buffbar", "tbuff", "sort", "asc")
  pfUI:UpdateConfig("buffbar", "tbuff", "color", ".5,.5,.5,1")
  pfUI:UpdateConfig("buffbar", "tbuff", "bordercolor", "0,0,0,0")
  pfUI:UpdateConfig("buffbar", "tbuff", "textcolor", "1,1,1,1")
  pfUI:UpdateConfig("buffbar", "tbuff", "dtypebg", "1")
  pfUI:UpdateConfig("buffbar", "tbuff", "dtypeborder", "0")
  pfUI:UpdateConfig("buffbar", "tbuff", "dtypetext", "0")
  pfUI:UpdateConfig("buffbar", "tbuff", "colorstacks", "0")
  pfUI:UpdateConfig("buffbar", "tbuff", "width", "-1")
  pfUI:UpdateConfig("buffbar", "tbuff", "height", "20")
  pfUI:UpdateConfig("buffbar", "tbuff", "filter", "blacklist")
  pfUI:UpdateConfig("buffbar", "tbuff", "threshold", "120")
  pfUI:UpdateConfig("buffbar", "tbuff", "whitelist", "")
  pfUI:UpdateConfig("buffbar", "tbuff", "blacklist", "")
